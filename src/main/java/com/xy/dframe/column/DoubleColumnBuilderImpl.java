...
/**
 * Created by sergey on 16/07/15.
 */
public class DoubleColumnBuilderImpl<I> implements DoubleColumnBuilder<I> {

    private static final int MIN_PARTITION_SIZE = 16;

    private final ToDoubleFunction<I> valueFunction;
    ...
    public DoubleColumnBuilderImpl(ToDoubleFunction<I> valueFunction, int expectedSize) {
        ...
        this.partition = new double[partitionSize];
    }
    ...
    public void add(I item) {
        ...
        try {
            ...
            partition = new double[partitionSize];
            partition[0] = value;
            size = 1;
        }
    }
